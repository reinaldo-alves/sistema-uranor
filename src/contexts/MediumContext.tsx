...
export const MediumStore = ({ children }: any) => {
    ...
    const convertMediumToSend = (medium: IMedium) => {
        const mediumObj = {
            ...medium,
            foto: medium.foto === '' ? null : medium.foto,
            dtNasc: medium.dtNasc === '' ? null : medium.dtNasc,
            rg: medium.rg === '' ? null : medium.rg,
            cpf: medium.cpf === '' ? null : medium.cpf,
            pai: medium.pai === '' ? null : medium.pai,
            natur: medium.natur === '' ? null : medium.natur,
            naturUF: medium.naturUF === '' ? null : medium.naturUF,
            profissao: medium.profissao === '' ? null : medium.profissao,
            estCivil: medium.estCivil === '' ? null : medium.estCivil,
            conjuge: medium.conjuge === '' ? null : medium.conjuge,
            cep: medium.cep === '' ? null : medium.cep,
            endereco: medium.endereco === '' ? null : medium.endereco,
            endNumero: medium.endNumero === '' ? null : medium.endNumero,
            endCompl: medium.endCompl === '' ? null : medium.endCompl,
            endBairro: medium.endBairro === '' ? null : medium.endBairro,
            endCidade: medium.endCidade === '' ? null : medium.endCidade,
            endUF: medium.endUF === '' ? null : medium.endUF,
            telefone1: medium.telefone1 === '' ? null : medium.telefone1,
            telefone2: !medium.telefone2 ? null : medium.telefone2,
            email: medium.email === '' ? null : medium.email,
            ...
            adjOrigem: !medium.adjOrigem ? null : medium.adjOrigem,
            temploOrigem: medium.temploOrigem === 0 ? null : medium.temploOrigem,
            colete: !medium.colete ? null : medium.colete,
            classMest: !medium.classMest ? null : medium.classMest,
            falMest: !medium.falMest ? null : medium.falMest,
            povo: !medium.povo ? null : medium.povo,
            falMiss: medium.falMiss === 0 ? null : medium.falMiss,
            adjDevas: !medium.adjDevas ? null : medium.adjDevas,
            turnoLeg: !medium.turnoLeg ? null : medium.turnoLeg,
            turnoTrab: !medium.turnoTrab ? null : medium.turnoTrab,
            ministro: !medium.ministro ? null : medium.ministro,
            cavaleiro: !medium.cavaleiro ? null : medium.cavaleiro,
            guia: !medium.guia ? null : medium.guia,
            dtMentor: !medium.dtMentor ? null : medium.dtMentor,
            cor: !medium.cor ? null : medium.cor,
            estrela: !medium.estrela ? null : medium.estrela,
            classif: !medium.classif ? null : medium.classif,
            dtClassif: !medium.dtClassif ? null : medium.dtClassif,
            princesa: !medium.princesa ? null : medium.princesa,
            pretovelho: !medium.pretovelho ? null : medium.pretovelho,
            caboclo: !medium.caboclo ? null : medium.caboclo,
            medico: !medium.medico ? null : medium.medico,
            nomeEmissao: medium.nomeEmissao === '' ? null : medium.nomeEmissao,
            ninfa: !medium.ninfa ? null : medium.ninfa,
            mestre: !medium.mestre ? null : medium.mestre,
            padrinho: !medium.padrinho ? null : medium.padrinho,
            madrinha: !medium.madrinha ? null : medium.madrinha,
            afilhado: !medium.afilhado ? null : medium.afilhado,
            comando: !medium.comando ? null : medium.comando,
            presidente: !medium.presidente ? null : medium.presidente,
            trinoSol: !medium.trinoSol ? null : medium.trinoSol,
            herdeiro: !medium.herdeiro ? null : medium.herdeiro,
            observ: !medium.observ ? null : medium.observ,
            oldFoto: !medium.oldFoto ? null : medium.oldFoto,
            ...
            oldClassMest: !medium.oldClassMest ? null : medium.oldClassMest,
            oldCavaleiro: !medium.oldCavaleiro ? null : medium.oldCavaleiro,
            oldCor: !medium.oldCor ? null : medium.oldCor,
            oldDtMentor: !medium.oldDtMentor ? null : medium.oldDtMentor,
            oldEstrela: !medium.oldEstrela ? null : medium.oldEstrela,
            oldClassif: !medium.oldClassif ? null : medium.oldClassif,
    ...
    const changeMed = async (medium: IMedium, token: string, dtTest: string) => {
        ...
        const editData = {
            ...
            cor: medium.sex === 'Feminino' ? medium.cor : medium.oldCor,
            dtMentor: medium.sex === 'Feminino' ? medium.dtMentor.split('T')[0] === '' ? null : medium.dtMentor.split('T')[0] : medium.oldDtMentor.split('T')[0] === '' ? null : medium.oldDtMentor.split('T')[0],
            ...
            oldCor: medium.sex === 'Feminino' ? '' : medium.cor,
            oldDtMentor: medium.sex === 'Feminino' ? medium.oldDtMentor.split('T')[0] === '' ? null : medium.oldDtMentor.split('T')[0] : medium.dtMentor.split('T')[0] === '' ? null : medium.dtMentor.split('T')[0],
