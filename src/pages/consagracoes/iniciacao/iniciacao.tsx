                ...
                <ModalMediumContent vis={selectModal === 'adicionar'}>
                    ...
                    <InputContainer>
                        ...
                        <AutocompleteInput 
                            ...
                            options={mediuns.filter((item: IMedium) => item.medium_id && setSituation(item) === 'Liberado' && item.condicao === 'Ativo' && searchMediumInCons(item.medium_id) === defaultConsagracao)}
