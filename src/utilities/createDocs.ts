...
import { assTiaNeiva } from './signature';
import { getCurrentDate } from './functions';

export const generateEmissao = (medium: IMedium, user: IUser) => {
    ...
    //     }
    // }
    console.log(pdfMake.vfs, pdfMake.fonts)
    ...
    pdfMake.createPdf(emissaoDefinitions).open({}, window.open('', '_blank'));
}